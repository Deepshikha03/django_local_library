...
from django.db.models.functions import Lower   # returns lowercased value of fields
...
class Book(models.Model):
    ...
    #ManytoManyField used because a genre can contain many book. Books can cover many genres.
